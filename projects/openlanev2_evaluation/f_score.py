...
class LaneEval(object):
    def __init__(self, vertical_lower=-50.0, vertical_upper=50.0, dist_th=1.5, ratio_th=0.75):
        self.x_samples = np.linspace(vertical_lower, vertical_upper, num=100, endpoint=False)
